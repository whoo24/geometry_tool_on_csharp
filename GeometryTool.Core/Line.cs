...
namespace GeometryTool.Core {
  ...
  public class Line {
    ...
    public static Line points_to_line (Coord2d p1, Coord2d p2) {
      Line line = new Line();
    ...
    public static Line point_and_slope_to_line (Coord2d p, double m) {
      Line line = new Line();
      line.a = -m;
      line.b = 1;
    ...
    public static bool intersection_point (Line l1, Line l2, ref Coord2d p) {
      p = new Coord2d();

      if (is_same(l1, l2)) {// 동일한 직선. 교점이 무한하게 많다.
        p.x = p.y = 0;
        return true;
      }
    ...
    public static bool closest_point (Coord2d v, Line l, ref Coord2d p) {
